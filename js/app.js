 ...
 */
    ...
    (() => {
        ...
        class MousePRLX {
            constructor(props, data = null) {
                ...
                if (this.config.init) {
                    ...
                    } else this.setLogging("Нет объекта");
                }
            }
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (phoneInputOne) Inputmask("+7 (999) 999-99-99").mask(phoneInputOne);
        }));
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new swiper_core_Swiper(".ibg__slider", {
                ...
                new swiper_core_Swiper(".documents__slider-two", {
                    modules: [ Navigation, Autoplay, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            const i = [ {
                ...
                name: "Автоматизированная загрузка отходов",
                id: "automated-loading"
            }, {
                name: "Колосниковые решетки",
                id: "grates"
            }, {
                name: "Генераторы",
                id: "generators"
            }, {
                name: "Емкость для ГСМ",
                id: "fuel-tanks"
            } ];
            e.addEventListener("focus", (function() {
                if (e.value) t.style.display = "block";
            }));
            ...
            form.addEventListener("submit", (function(event) {
                ...
                if (matchedItem) window.location.href = `katalog?search=${encodeURIComponent(matchedItem.name)}`; else {
                    e.value = "";
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (main && (main.classList.contains("docs") || main.classList.contains("leasing"))) wrapper.classList.add("background-image");
        }));
        document.addEventListener("DOMContentLoaded", (function() {
            const wrapper = document.querySelector(".wrapper");
            const main = document.querySelector("main");
            if (main && main.classList.contains("product")) wrapper.classList.add("background-product");
        }));
        document.addEventListener("DOMContentLoaded", (function() {
            const addressLink = document.getElementById("addressLink");
            const mapContainer = document.getElementById("mapContainer");
            if (addressLink && mapContainer) addressLink.addEventListener("click", (function(e) {
                e.preventDefault();
